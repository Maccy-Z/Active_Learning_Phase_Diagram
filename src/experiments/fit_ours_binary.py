...
from src.utils import bin_pd
from matplotlib import pyplot as plt
import time
from dataclasses import dataclass

# Custom config file for this test
@dataclass
class Config:
    """ Experiment setup """
    ...
    """GP parameters"""
    obs_prob: float = 0.90  # Default certainty of observations. (Not too close to 1 or 0)
...
for i in range(51):
    ...
    obs_phase, obs_prob = pd_fn(new_point, train=True)
    distance_sampler.add_obs(obs_phase, new_point, prob=obs_prob)
