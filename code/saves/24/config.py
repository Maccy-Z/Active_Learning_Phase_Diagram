...
class Config:
    ...
    sample_old: int = 50  # Samples for P_{n}
    sample_new: int = 50  # Samples for P_{n+1}
    skip_point: float = 1.  # Min prob to entirely skip a point
    skip_phase: float = 0.0025 # Min prob to skip sampling a phase
